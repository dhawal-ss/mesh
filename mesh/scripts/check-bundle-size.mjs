...
const budgets = Object.freeze({
  entryBytes: 350 * 1024,
  // Eager JavaScript (everything loaded on first paint, not behind a lazy
  // boundary): framer-motion's core reached through LazyMotion/MotionConfig in
  // main.tsx, since the feature bundle (domAnimation) is already deferred by
  // lib/motion-features.ts. Entry stays at 350 KiB, the chunk that actually
  // blocks paint.
  ...
  totalJavaScriptBytes: 2_240 * 1024,
  totalCssBytes: 115 * 1024,
  totalFontBytes: 400 * 1024,
  totalAssetBytes: 2_620 * 1024,
})
