...
$script:RequiredMatrixRtcCases = @(
    ...
    "camera-start-stop-and-audio-only-fallback",
    "camera-permission-denied-and-recovery",
    "screen-share-start-stop-and-native-end",
    "screen-share-picker-cancel-and-permission-recovery",
    "screen-share-display-audio",
    "screen-share-reconnect-and-late-join",
    "screen-share-camera-coexistence",
    ...
    "camera-device-switch-and-reconnect"
)
...
$script:ExpectedAuthorizationImage = "ghcr.io/dhawal-ss/mesh-lk-jwt-service:0.5.0-mesh.2@sha256:78bf2f1e8535928037abc35a9886614b3f722885b54f1f707a570e6991252710"
