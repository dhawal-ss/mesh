      ...
      <DialogPrimitive.Portal>
        ...
        */}
        <DialogPrimitive.Content className="mesh-command-surface fixed inset-x-0 top-0 z-modal overflow-hidden rounded-b-xl bg-surface-container-high shadow-elev-3 outline-none">
          ...
          />
          {busyOption || note ? (
            <p role="status" className="border-t border-outline-variant py-2 text-label-sm text-on-surface-variant">
              {busyOption
            ...
            */
            <p className="flex items-center gap-3 border-t border-outline-variant py-2 text-label-sm text-on-surface-variant">
              <span>{'\u2191\u2193'} Move</span>
