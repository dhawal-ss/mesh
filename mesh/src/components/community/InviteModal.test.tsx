...
describe('InviteModal', () => {
  ...
  it('makes a private link primary while retaining direct account invites in Matrix mode', async () => {
    ...
    expect(document.body.textContent).toContain('Mesh username or account address')
    expect(document.body.textContent).toContain('A short username uses your account service.')
  })
