...
export function RoomContextPanel({
  ...
  return (
    ...
    >
      ...
      />
      <div className="mesh-room-context-header flex-shrink-0 border-b border-outline-variant">
      ...
      {activeTab === 'people' && (
        ...
        >
          ...
          */}
          <div className="mesh-room-context-summary flex flex-col gap-1 border-b border-outline-variant px-3 pb-4 pt-3">
