...
describe('persistent panel layout', () => {
  ...
  it('clamps stored widths and defaults room details open until the user closes it', () => {
    ...
    expect(readStoredBoolean(ROOM_CONTEXT_OPEN_KEY, true)).toBe(true)

    writeStoredBoolean(ROOM_CONTEXT_OPEN_KEY, false)
    expect(readStoredBoolean(ROOM_CONTEXT_OPEN_KEY, true)).toBe(false)
  })
