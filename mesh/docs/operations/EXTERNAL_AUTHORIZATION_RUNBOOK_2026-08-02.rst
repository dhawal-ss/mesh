...
protected evidence manifests. Complete acceptance testing across Windows, macOS,
and Linux in a separately retained artifact before any public promotion. A
failed case keeps its capability blocked.
