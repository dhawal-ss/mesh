...
* Mesh client vulnerabilities use the confidential route published on the
  security page: GitHub private vulnerability reporting at
  https://github.com/dhawal-ss/mesh/security/advisories/new. Exploit details
  must not be placed in a public issue.
