...
use crate::types::dm::{DirectMessageDto, DmConversationDto, DmPeerDto};
    ...
    pub fn get_or_create_dm_conversation(
        ...
        let existing = conn
            ...
            .query_row(params![peer_public_key], |row| {
                ...
                let avatar_color: String = row.get(3)?;
                Ok(DmConversationDto {
                    ...
                    peers: vec![DmPeerDto {
                        ...
                        display_name,
                        avatar_color,
                        // The peer-to-peer network carries no profile picture.
                        avatar_url: None,
                    }],
        ...
        Ok(DmConversationDto {
            id,
            peers: vec![DmPeerDto {
                user_id: peer_public_key.to_string(),
                display_name: peer_display_name.to_string(),
                avatar_color: peer_avatar_color.to_string(),
                avatar_url: None,
            }],
