...
pub(super) const ADMISSION_RESPONSE_MAX_BYTES: usize = 64 * 1024;
...
pub(super) struct AdmissionCreateResponse {
    pub(super) invite_url: String,
}

#[derive(Debug, Deserialize)]
pub(super) struct AdmissionServiceResponse {
    pub(super) version: u8,
    #[serde(default)]
    pub(super) registration_token: Option<String>,
    ...
    #[serde(default)]
    pub(super) community_name: Option<String>,
    #[serde(default)]
    pub(super) inviter_display_name: Option<String>,
    #[serde(default)]
    pub(super) inviter_user_id: Option<String>,
    #[serde(default)]
    pub(super) join_rule: Option<String>,
    #[serde(default)]
    pub(super) community_service_display_name: Option<String>,
}
...
pub(super) struct AdmissionInvitationTarget {
    pub(super) code: String,
    pub(super) api_origin: url::Url,
    pub(super) via: Vec<String>,
    pub(super) via_truncated: bool,
}
...
impl MatrixBackend {
    pub(super) fn community_admission_origin() -> BackendResult<url::Url> {
    ...
    pub(super) fn normalize_admission_origin(value: &str) -> BackendResult<url::Url> {
    ...
    pub(super) fn unsafe_admission_address(address: std::net::IpAddr) -> bool {
        match address {
    ...
    pub(super) fn parse_admission_invitation(
        invite_url: &str,
    ...
    pub(super) fn parse_direct_community_invitation(
        invite_url: &str,
    ...
    pub(super) fn admission_endpoint(
        origin: &url::Url,
        operation: &str,
    ...
    pub(super) async fn admission_http_client(origin: &url::Url) -> BackendResult<reqwest::Client> {
    ...
    pub(super) fn append_admission_response_chunk(
        buffer: &mut Vec<u8>,
        chunk: &[u8],
    ) -> BackendResult<()> {
        if buffer
    ...
    pub(super) async fn admission_response_bytes(
    ...
    pub(super) fn admission_error_response(
    ...
    pub(super) fn validate_admission_response(
        response: AdmissionServiceResponse,
        require_registration: bool,
    ) -> BackendResult<crate::backend::MatrixCommunityAdmission> {
        ...
        let join_rule = response
            ...
            .transpose()?;
        Ok(crate::backend::MatrixCommunityAdmission {
    ...
    pub(super) async fn resolve_admission_invitation(
        &self,
        invite_url: &str,
        require_registration: bool,
    ) -> BackendResult<crate::backend::MatrixCommunityAdmission> {
